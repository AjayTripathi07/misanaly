...
class ProductsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $features = [
            ...
            [
                'title'       => 'AI Ledger Mapping',
                'description' => 'Every transaction is automatically matched to the correct Tally ledger head using AI-powered auto-tagging rules.',
                'icon'        => 'ListTree',
                'sort_order'  => 4,
            ],
            [
            ...
            [
                ...
                'description' => 'Pushed a batch by mistake? Roll back an entire import in one click and your Tally books return to exactly how they were before.',
                'icon'        => 'RotateCcw',
                'sort_order'  => 6,
            ],
            [
