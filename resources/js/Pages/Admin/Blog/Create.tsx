...
export default function AdminBlogCreate({ categories: initialCategories }: Props) {
    ...
    function handleSubmit(e: React.FormEvent, status: 'draft' | 'published') {
        ...
        // Use post after state update — set directly on form payload
        post('/admin/blog', {
            data: { ...data, status },
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <div className="xl:col-span-1 space-y-5">
                        ...
                        <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                            <h3 className="font-semibold text-[#0F172A] mb-4">Publish</h3>
