...
export default function TestimonialsCreate({ services, products }: Props) {
    ...
    return (
        <AdminLayout title="Add Testimonial">
            ...
            <div className="mb-6">
                ...
                <h2 className="text-xl font-bold text-[#0F172A] mt-2">Add Testimonial</h2>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex items-center gap-3 pt-2">
                        <Button type="submit" disabled={processing} className="bg-[#2563EB] hover:bg-[#1d4ed8] text-white">
                            {processing ? 'Saving…' : 'Add Testimonial'}
                        </Button>
